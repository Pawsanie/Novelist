    ...
    def __call__(self):
        ...
        if self.scene_flag != self.scene:
            ...
            for name in scene['actors']:
                ...
                self.stage_director.set_actor(character=name).set_pose(pose_number=character['character_pose'])
                self.stage_director.set_actor(character=name).set_plan(plan=character['character_plan'])
